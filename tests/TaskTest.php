...
class TaskTest extends PHPUnit_Framework_TestCase
{
    ...
    public function find_task_by_id()
    {
        ...
        $this->assertInstanceOf('MLS\Capsule\Task', $task);
        ...
        $this->assertEquals('2016-02-24T00:00:00Z', $task->due_date);
    ...
    public function find_all_tasks()
    {
        ...
        $this->assertInstanceOf('MLS\Capsule\Task', $collection[0]);
    }
    ...
    public function should_serialise_model()
    {
        $task = new Task($this->connection, [
          ...
          'due_date_time' => '2016-04-21T15:00:00Z'
        ]);
